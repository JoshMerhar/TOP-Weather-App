...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n  if (!url) {\n    return url;\n  }\n  url = String(url.__esModule ? url.default : url);\n\n  // If url is already wrapped in quotes, remove them\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n  if (options.hash) {\n    url += options.hash;\n  }\n\n  // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n  return url;\n};\n\n//# sourceURL=webpack://top-weather-app/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./styles.css */ \"./src/styles.css\");\n/* harmony import */ var _data_manager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./data-manager */ \"./src/data-manager.js\");\n/* harmony import */ var _dom_manager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dom-manager */ \"./src/dom-manager.js\");\n\n\n\n\nconst submitSearch = document.querySelector('#submit-search');\nsubmitSearch.addEventListener('click', async () => {\n    try {\n        const weatherData = await _data_manager__WEBPACK_IMPORTED_MODULE_1__.dataManager.getWeatherData();\n        if (!weatherData.error) {\n            const currentWeather = _data_manager__WEBPACK_IMPORTED_MODULE_1__.dataManager.getCurrentWeather(weatherData);\n            _dom_manager__WEBPACK_IMPORTED_MODULE_2__.domManager.displayWeather(currentWeather);\n        }\n    } catch (error) {\n        return _dom_manager__WEBPACK_IMPORTED_MODULE_2__.domManager.displayError();\n    }\n});\n\n\n//# sourceURL=webpack://top-weather-app/./src/index.js?");
...
eval("module.exports = __webpack_require__.p + \"99cbdc84cf886cb6d8e2.woff\";\n\n//# sourceURL=webpack://top-weather-app/./src/Font/roboto-regular-webfont.woff?");
...
eval("module.exports = __webpack_require__.p + \"d581dd33a2c04cbf70d1.woff2\";\n\n//# sourceURL=webpack://top-weather-app/./src/Font/roboto-regular-webfont.woff2?");
